...
public class SS1332HW8Tests {
    ...
    public static final Comparator<SortingObj> COMP = (o1, o2) -> o1.value - o2.value;
    public static final Comparator<StableSortingObj> STABLE_COMP = (o1, o2) -> o1.value - o2.value;
    ...
    public void testQuickException4() {
        Sorting.quickSort(new SortingObj[0], COMP, null);
    }
    @Test(timeout = TIMEOUT, expected = IllegalArgumentException.class)
    public void testQuickException5() {
        Sorting.quickSort(null, COMP, null);
    }
    @Test(timeout = TIMEOUT, expected = IllegalArgumentException.class)
    ...
    public void testBubblePermutations() {
        ...
        working[3] = sorted[3];
        working[4] = sorted[4];
        Sorting.bubbleSort(working, STABLE_COMP);
    ...
    public void testBubbleLong() {
        ...
        Arrays.sort(sortedStable, STABLE_COMP);
    ...
    public void testInsertionPermutations() {
        ...
        working[3] = sorted[3];
        working[4] = sorted[4];
        Sorting.insertionSort(working, STABLE_COMP);
        Assert.assertArrayEquals("Array sorted incorrectly: " + Arrays.deepToString(working), sorted, working);
        working[0] = sorted[1];
        working[1] = sorted[0];
        working[2] = sorted[2];
    ...
    public void testMergePermutations() {
        ...
        working[3] = sorted[3];
        working[4] = sorted[4];
        Sorting.mergeSort(working, STABLE_COMP);
        Assert.assertArrayEquals("Array sorted incorrectly: " + Arrays.deepToString(working), sorted, working);
        working[0] = sorted[1];
        working[1] = sorted[0];
        working[2] = sorted[2];
    ...
    public void testEmptyArrays() {
        Sorting.bubbleSort(new SortingObj[0], COMP);
        Sorting.insertionSort(new SortingObj[0], COMP);
        Sorting.selectionSort(new SortingObj[0], COMP);
        Sorting.quickSort(new SortingObj[0], COMP, new Random(0));
        Sorting.mergeSort(new SortingObj[0], COMP);
